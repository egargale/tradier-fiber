...
ALTER FUNCTION film_in_stock(p_film_id integer, p_store_id integer, OUT p_film_count integer) OWNER TO postgres;
...
ALTER FUNCTION get_customer_balance(p_customer_id integer, p_effective_date timestamp with time zone) OWNER TO postgres;
...
ALTER FUNCTION inventory_held_by_customer(p_inventory_id integer) OWNER TO postgres;
...
ALTER FUNCTION inventory_in_stock(p_inventory_id integer) OWNER TO postgres;
...
ALTER FUNCTION last_day(timestamp with time zone) OWNER TO postgres;
...
ALTER FUNCTION rewards_report(min_monthly_purchases integer, min_dollar_amount_purchased numeric) OWNER TO postgres;
...
ALTER TABLE ONLY payment ATTACH PARTITION payment_p2020_01 FOR VALUES FROM ('2020-01-01 00:00:00+00') TO ('2020-02-01 00:00:00+00');
...
ALTER TABLE ONLY payment ATTACH PARTITION payment_p2020_02 FOR VALUES FROM ('2020-02-01 00:00:00+00') TO ('2020-03-01 00:00:00+00');
...
ALTER TABLE ONLY payment ATTACH PARTITION payment_p2020_03 FOR VALUES FROM ('2020-03-01 00:00:00+00') TO ('2020-04-01 01:00:00+01');
...
ALTER TABLE ONLY payment ATTACH PARTITION payment_p2020_04 FOR VALUES FROM ('2020-04-01 01:00:00+01') TO ('2020-05-01 01:00:00+01');
...
ALTER TABLE ONLY payment ATTACH PARTITION payment_p2020_05 FOR VALUES FROM ('2020-05-01 01:00:00+01') TO ('2020-06-01 01:00:00+01');
...
ALTER TABLE ONLY payment ATTACH PARTITION payment_p2020_06 FOR VALUES FROM ('2020-06-01 01:00:00+01') TO ('2020-07-01 01:00:00+01');
...
CREATE INDEX idx_fk_customer_id ON ONLY payment USING btree (customer_id);
...
CREATE INDEX idx_fk_staff_id ON ONLY payment USING btree (staff_id);
...
CREATE INDEX payment_p2020_01_customer_id_idx ON payment_p2020_01 USING btree (customer_id);
...
CREATE INDEX payment_p2020_02_customer_id_idx ON payment_p2020_02 USING btree (customer_id);
...
CREATE INDEX payment_p2020_03_customer_id_idx ON payment_p2020_03 USING btree (customer_id);
...
CREATE INDEX payment_p2020_04_customer_id_idx ON payment_p2020_04 USING btree (customer_id);
...
CREATE INDEX payment_p2020_05_customer_id_idx ON payment_p2020_05 USING btree (customer_id);
...
CREATE INDEX payment_p2020_06_customer_id_idx ON payment_p2020_06 USING btree (customer_id);
...
ALTER INDEX idx_fk_staff_id ATTACH PARTITION idx_fk_payment_p2020_01_staff_id;
...
ALTER INDEX idx_fk_staff_id ATTACH PARTITION idx_fk_payment_p2020_02_staff_id;
...
ALTER INDEX idx_fk_staff_id ATTACH PARTITION idx_fk_payment_p2020_03_staff_id;
...
ALTER INDEX idx_fk_staff_id ATTACH PARTITION idx_fk_payment_p2020_04_staff_id;
...
ALTER INDEX idx_fk_staff_id ATTACH PARTITION idx_fk_payment_p2020_05_staff_id;
...
ALTER INDEX idx_fk_staff_id ATTACH PARTITION idx_fk_payment_p2020_06_staff_id;
...
ALTER INDEX idx_fk_customer_id ATTACH PARTITION payment_p2020_01_customer_id_idx;
...
ALTER INDEX idx_fk_customer_id ATTACH PARTITION payment_p2020_02_customer_id_idx;
...
ALTER INDEX idx_fk_customer_id ATTACH PARTITION payment_p2020_03_customer_id_idx;
...
ALTER INDEX idx_fk_customer_id ATTACH PARTITION payment_p2020_04_customer_id_idx;
...
ALTER INDEX idx_fk_customer_id ATTACH PARTITION payment_p2020_05_customer_id_idx;
...
ALTER INDEX idx_fk_customer_id ATTACH PARTITION payment_p2020_06_customer_id_idx;
...
ALTER TABLE ONLY payment_p2020_01
    ADD CONSTRAINT payment_p2020_01_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES customer(customer_id);
...
ALTER TABLE ONLY payment_p2020_01
    ADD CONSTRAINT payment_p2020_01_rental_id_fkey FOREIGN KEY (rental_id) REFERENCES rental(rental_id);
...
ALTER TABLE ONLY payment_p2020_01
    ADD CONSTRAINT payment_p2020_01_staff_id_fkey FOREIGN KEY (staff_id) REFERENCES staff(staff_id);
...
ALTER TABLE ONLY payment_p2020_02
    ADD CONSTRAINT payment_p2020_02_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES customer(customer_id);
...
ALTER TABLE ONLY payment_p2020_02
    ADD CONSTRAINT payment_p2020_02_rental_id_fkey FOREIGN KEY (rental_id) REFERENCES rental(rental_id);
...
ALTER TABLE ONLY payment_p2020_02
    ADD CONSTRAINT payment_p2020_02_staff_id_fkey FOREIGN KEY (staff_id) REFERENCES staff(staff_id);
...
ALTER TABLE ONLY payment_p2020_03
    ADD CONSTRAINT payment_p2020_03_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES customer(customer_id);
...
ALTER TABLE ONLY payment_p2020_03
    ADD CONSTRAINT payment_p2020_03_rental_id_fkey FOREIGN KEY (rental_id) REFERENCES rental(rental_id);
...
ALTER TABLE ONLY payment_p2020_03
    ADD CONSTRAINT payment_p2020_03_staff_id_fkey FOREIGN KEY (staff_id) REFERENCES staff(staff_id);
...
ALTER TABLE ONLY payment_p2020_04
    ADD CONSTRAINT payment_p2020_04_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES customer(customer_id);
...
ALTER TABLE ONLY payment_p2020_04
    ADD CONSTRAINT payment_p2020_04_rental_id_fkey FOREIGN KEY (rental_id) REFERENCES rental(rental_id);
...
ALTER TABLE ONLY payment_p2020_04
    ADD CONSTRAINT payment_p2020_04_staff_id_fkey FOREIGN KEY (staff_id) REFERENCES staff(staff_id);
...
ALTER TABLE ONLY payment_p2020_05
    ADD CONSTRAINT payment_p2020_05_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES customer(customer_id);
...
ALTER TABLE ONLY payment_p2020_05
    ADD CONSTRAINT payment_p2020_05_rental_id_fkey FOREIGN KEY (rental_id) REFERENCES rental(rental_id);
...
ALTER TABLE ONLY payment_p2020_05
    ADD CONSTRAINT payment_p2020_05_staff_id_fkey FOREIGN KEY (staff_id) REFERENCES staff(staff_id);
...
ALTER TABLE ONLY payment_p2020_06
    ADD CONSTRAINT payment_p2020_06_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES customer(customer_id);
...
ALTER TABLE ONLY payment_p2020_06
    ADD CONSTRAINT payment_p2020_06_rental_id_fkey FOREIGN KEY (rental_id) REFERENCES rental(rental_id);
...
ALTER TABLE ONLY payment_p2020_06
    ADD CONSTRAINT payment_p2020_06_staff_id_fkey FOREIGN KEY (staff_id) REFERENCES staff(staff_id);
